...
## Project Structure
    ...
    ├── testnotification_de_30713  # Django project configurations
...
1. Clone this repo and `cd testnotification_de_30713`
...
2. Clone this repo and `cd testnotification_de_30713`
